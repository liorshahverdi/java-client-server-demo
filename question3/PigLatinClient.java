/**
 * PigLatinClient
 * Sends string to PigLatinServer and receives PigLatin equivalent in return. 
 * 
 * Invoke as: java PigLatinClient [-port=<number>] [server]
...
public class PigLatinClient
{
    public static void main (String [] args)
    {
        ...
        if (args.length > 2) 
        {
            System.out.println("Usage: java PigLatinClient "
                               + "[-port=<number>] [server]");
            System.exit(-1); 
        }
        ...
        System.out.println("Hello, you have invoked a Pig Latin Client"); 
